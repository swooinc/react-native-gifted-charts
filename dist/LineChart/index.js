...
import { adjustToOffset, getRegionPathObjects, getSegmentedPathObjects, LineDefaults, pointsWithPaddedRepititions, RANGE_ENTER, RANGE_EXIT, SEGMENT_END, SEGMENT_START, STOP, useLineChart, } from 'gifted-charts-core';
import { Fragment, useCallback, useEffect, useMemo, useRef } from 'react';
import { Animated, Dimensions, Easing, I18nManager, Text, View, } from 'react-native';
import Svg, { Text as CanvasText, Circle, ClipPath, Line, LinearGradient, Path, Rect, Stop, Use, } from 'react-native-svg';
...
export var LineChart = function (props) {
    ...
    var renderLabel = function (top, index, label, labelTextStyle, labelComponent) {
        var _a, _b;
        var xLabelWidth = props.xLabelWidth;
